...
**GitHub：** [hypit-ai/hypit](https://github.com/hypit-ai/hypit)

**一句话：** 把爆款视频结构拆出来，换成你的产品/人物/台词，一键生成新视频！
...
1. **词级对齐**：画面、字幕全部挂在词上，不是钉在秒上
   - 台词改一个字，画面和字幕自动跟着动
   - 不用重新拉时间轴！
2. **工作流复用**：拆好一条视频的结构，以后批量出片
3. **BYOK 自带密钥**：支持用自己的 API Key 接各种模型
4. **AI Agent 原生**：给 Claude Code / Codex 装上技能，用自然语言做视频
...
找一条你觉得节奏很好的爆款视频，下载到本地。

#### 第三步：在 AI Agent 里启动

打开 Claude Code / Codex，输入：
```
/hypit
参考这个视频：/path/to/your/video.mp4
我想保留它的开场节奏和画面结构，把里面的人物和台词换成我的版本。
请先帮我拆解，不要直接生成。
```
